#!/usr/bin/env python3
"""
Run AdvancedCoLight-framework variants on Hangzhou real 5816:
1) true-REDQ + Trans (base)
2) true-REDQ + Trans + CoS
3) true-REDQ + Trans + RELight (vote)

Implementation uses MHQCoSLight model backend with:
- AdvancedCoLight state/reward settings
- toggled CoS/Transformer/RELight modules per variant
"""
...
def parse_args():
    ...
    parser.add_argument("-memo_prefix", type=str, default="adcolight_hz5816_s42_60r")
...
def main():
    ...
    exp_id = "mhq_coslight_hz_5816_{}".format(
