...
from models.ppo_colight_agent import PPOCoLightAgent
...
dic_traffic_env_conf = {
    ...
    "LIST_MODEL": ["Fixedtime",  "MaxPressure", "EfficientMaxPressure", "AdvancedMaxPressure",
                   ...
                   "AdvancedMPLight", "AdvancedColight", "AdvancedDQN", "Attend", "MHQCoSLight"],
